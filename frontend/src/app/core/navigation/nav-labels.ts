...
const NAV_LABELS: Readonly<Record<string, string>> = {
  ...
  'nav.admissions.enquiries': 'Enquiries',
  'nav.admissions.follow_ups': 'Follow-up queue',
  'nav.students': 'Students',
  'nav.students.all': 'All students',
  'nav.students.guardians': 'Guardians',
  'nav.students.import': 'Import students',
  ...
  'nav.attendance.mark': 'Mark attendance',
  'nav.attendance.leave': 'Leave requests',
  'nav.attendance.corrections': 'Corrections',
  'nav.exams': 'Exams',
  'nav.fees': 'Fees',
  'nav.fees.heads': 'Fee heads',
  'nav.fees.structure': 'Fee structure',

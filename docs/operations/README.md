...
([ADR-0003](../architecture/adr/0003-authentication-and-authorization.md)) and the database is
in-memory H2 ([ADR-0004](../architecture/adr/0004-h2-now-postgresql-next.md)). Do not expose this
deployment publicly until both are closed.
